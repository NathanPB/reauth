...
import dev.nathanpb.reauth.config.ReauthConfigLoader

lateinit var reauth: ReauthServer

fun main() {
    val env = ReauthConfigLoader.loadEnv()
    reauth = ReauthServerImpl(env, ReauthConfigLoader.loadConfig(env))
    reauth.boot()
}
